  ...
  return (
    <div className={styles.panel}>
      <div className={styles.queryRow}>
        ...
        />
        <button type="button" className={`${styles.toggle} ${matchCase ? styles.toggleOn : ''}`} title="Match case" aria-pressed={matchCase} onClick={() => setMatchCase((v) => !v)}>
          Aa
        </button>
        <button type="button" className={`${styles.toggle} ${wholeWord ? styles.toggleOn : ''}`} title="Match whole word" aria-pressed={wholeWord} onClick={() => setWholeWord((v) => !v)}>
          ab
        </button>
        <button type="button" className={`${styles.toggle} ${useRegex ? styles.toggleOn : ''}`} title="Use regular expression" aria-pressed={useRegex} onClick={() => setUseRegex((v) => !v)}>
          .*
        </button>
        <button type="button" className={`${styles.toggle} ${showFilters ? styles.toggleOn : ''}`} title="Toggle search details" aria-pressed={showFilters} onClick={() => setShowFilters((v) => !v)}>
          …
        </button>
      </div>
