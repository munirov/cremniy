...
Спасибо за ваш интерес к проекту **Cremniy**! Любая помощь в улучшении проекта **приветствуется**!

Присоединяйтесь к чату контрибьютеров **[в Telegram](https://t.me/cremniy_com)**

## Содержание

- [1. Как можно помочь](#1-как-можно-помочь)
- [2. Где найти задачи](#2-где-найти-задачи)
- [3. Pull Requests](#3-pull-requests)
- [4. Благодарность](#4-благодарность)
- [5. Языковая политика](#5-языковая-политика)
- [6. Работа с ветками](#6-работа-с-ветками)
- [7. Правила оформления кода](#7-правила-оформления-кода)
	- [7.1. Комментарии](#71-комментарии)
 	- [7.2. Определения классов, структур и других единиц](#72-определения-классов-структур-и-других-единиц)
	- [7.3. Указатели и ссылки и огромные функции](#73-указатели-и-ссылки-и-огромные-функции)
- [8. Оформление текстовых элементов UI](#8-оформление-текстовых-элементов-пользовательского-интерфейса)
...
- предлагать новые функции (создайте новый **Issue** по шаблону `Feature`)
- улучшать документацию
- отправлять Pull Request'ы с улучшениями или решениями задач ([подробнее](CONTRIBUTING_ru.md#pull-requests))
...
Перед отправкой PR, **пожалуйста**, прочитайте требования и инструкции приведенные ниже.
...
Все контрибьюторы будут навсегда добавлены **в специальное окно "Благодарности"** прямо внутри Cremniy
и будут **упомянаться в конце каждого видео** на [YouTube-канале](https://www.youtube.com/@igmunv)
...
### 7.2. Определения классов, структур и других единиц
...
### 7.3. Указатели и ссылки и огромные функции
...
## 8. Оформление текстовых элементов пользовательского интерфейса
